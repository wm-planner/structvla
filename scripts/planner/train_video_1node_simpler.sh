...
EXP_NAME="STRUCTURED_PLANNER_BRIDGE_30K"
...
torchrun \
    ...
    --run_name ${EXP_NAME} \
    --planner True \
    --keystep_path "/remote-home/jinminghao/structvla/documents/bridge_keysteps/triplets_manifest.csv" \
