...
sys.path.append("/remote-home/jinminghao/structvla/reference/RoboVLMs/LIBERO")
...
def parser_args():
    ...
    parser.add_argument('--cache_root', type=str, default="/remote-home/jinminghao/structvla/logs/libero",
