...
try:
    from lightning.fabric.utilities.types import _PATH  # type: ignore
except Exception:
    from typing import Union
    import os
    _PATH = Union[str, os.PathLike]  # Fallback used only for type annotations
...
def convert_zero_checkpoint_to_fp32_state_dict(
    ...
    state_dict = {
        _remove_prefix(k, "_forward_module."): state_dict[k] for k in state_dict
    }
